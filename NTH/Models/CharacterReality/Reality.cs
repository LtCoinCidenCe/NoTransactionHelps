...
public static class Reality
{
	static Reality()
	{
		Characters = [
			...
			new() { Nameue = "小春", Nameshita = "六花", Introduction = "中国古詩" },
			new() { Nameue = "花隈", Nameshita = "千冬", Introduction = "文芸眼鏡娘" },
			new() { Nameue = "四国", Nameshita = "めたん", Introduction = "常に金欠高等部二年生" },
			new() { Nameue = "春日部", Nameshita = "つむぎ", Introduction = "埼玉ギャル" },
		];
