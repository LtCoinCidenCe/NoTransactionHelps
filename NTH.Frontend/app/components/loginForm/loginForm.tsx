  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
      ...
      <form method="POST" className="w-full max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 space-y-6"
        ...
        {/* 标题：居中、加粗、渐变色文字 */}
        <h1 className="text-3xl font-bold text-center bg-clip-text text-transparent bg-linear-to-r from-45% from-purple-600 to-55% to-[#ea8a15]">
          super翻译
        </h1>
